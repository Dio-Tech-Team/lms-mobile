...
class LeaveMonetizationService {
  ...
  static Future<Map<String, dynamic>> getLeaveConfigurations({
    ...
    try {
      ...
      return {'success': false, 'message': 'Network error while loading leave types.'};
    }
  }
  ...
  static Future<Map<String, dynamic>> getMyRequests({
    ...
    try {
      ...
      return {'success': false, 'message': 'Network error while loading requests.'};
    }
  }
  ...
  static Future<Map<String, dynamic>> apply({
    ...
    try {
      ...
      return {
        'success': false,
        'message': decoded['message'] ?? 'Failed to submit request (${res.statusCode}).',
      };
    } catch (e) {
